...
- Evaluation 最长路径 latency：`4.169283550 s`
- DAG：6050 个节点，14000 条边
- 完整候选目录：`/Users/cookie/Documents/wiki/DAGBuilder_LLM/outputs/scoreexpert_32g_7scenes_v2_20260726_210942/s6_four_symmetric/evaluations/eval_pp16_mbn64_tp2_dp1`
- 受慢卡影响的 TP group：4 个
...
|---:|---:|---:|---:|---:|---:|---|---|
| 1 | 16 | 2 | 1 | 64 | 4.169283550 | `pass` | `pass` |
| 2 | 1 | 8 | 4 | 4 | 4.238720099 | `pass` | `pass` |
| 3 | 8 | 4 | 1 | 64 | 4.301445102 | `pass` | `pass` |
| 4 | 8 | 4 | 1 | 32 | 4.402871026 | `pass` | `pass` |
| 5 | 2 | 4 | 4 | 8 | 4.422282283 | `pass` | `pass` |
| 6 | 8 | 2 | 2 | 64 | 4.447027969 | `pass` | `pass` |
| 7 | 32 | 1 | 1 | 64 | 4.480018551 | `pass` | `pass` |
| 8 | 4 | 4 | 2 | 32 | 4.489842703 | `pass` | `pass` |
| 9 | 2 | 4 | 4 | 16 | 4.491254410 | `pass` | `pass` |
| 10 | 4 | 4 | 2 | 16 | 4.533767988 | `pass` | `pass` |
