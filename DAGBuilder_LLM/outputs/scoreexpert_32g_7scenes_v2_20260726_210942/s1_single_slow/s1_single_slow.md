...
- `PP=32, TP=1, DP=1, MBN=64`
- Evaluation 最长路径 latency：`3.720621768 s`
- DAG：8130 个节点，18144 条边
- 完整候选目录：`/Users/cookie/Documents/wiki/DAGBuilder_LLM/outputs/scoreexpert_32g_7scenes_v2_20260726_210942/s1_single_slow/evaluations/eval_pp32_mbn64_tp1_dp1`
- 受慢卡影响的 TP group：1 个
...
|---:|---:|---:|---:|---:|---:|---|---|
| 1 | 32 | 1 | 1 | 64 | 3.720621768 | `pass` | `pass` |
| 2 | 16 | 2 | 1 | 64 | 3.729096448 | `pass` | `pass` |
