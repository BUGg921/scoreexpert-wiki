# s4_two_same_affinity：两张慢卡同亲和组跨节点
...
- Evaluation 最长路径 latency：`3.875337256 s`
- DAG：6050 个节点，14000 条边
- 完整候选目录：`/Users/cookie/Documents/wiki/DAGBuilder_LLM/outputs/scoreexpert_32g_7scenes_v2_20260726_210942/s4_two_same_affinity/evaluations/eval_pp16_mbn64_tp2_dp1`
- 受慢卡影响的 TP group：2 个
...
|---:|---:|---:|---:|---:|---:|---|---|
| 1 | 16 | 2 | 1 | 64 | 3.875337256 | `pass` | `pass` |
| 2 | 32 | 1 | 1 | 64 | 3.972777577 | `pass` | `pass` |
| 3 | 8 | 4 | 1 | 32 | 4.036424066 | `pass` | `pass` |
| 4 | 16 | 2 | 1 | 32 | 4.072329818 | `pass` | `pass` |
| 5 | 8 | 4 | 1 | 64 | 4.106461622 | `pass` | `pass` |
| 6 | 8 | 4 | 1 | 16 | 4.172828956 | `pass` | `pass` |
| 7 | 1 | 8 | 4 | 4 | 4.238720099 | `pass` | `pass` |
| 8 | 4 | 8 | 1 | 16 | 4.303050489 | `pass` | `pass` |
| 9 | 4 | 8 | 1 | 8 | 4.314444559 | `pass` | `pass` |
| 10 | 2 | 4 | 4 | 8 | 4.422282283 | `pass` | `pass` |
