# s0_homogeneous：32卡同构基线

- 经验候选判定：`KEEP_FOR_VALIDATION`
- 优化目标：`latency-first`
- 场景分类：`homogeneous-baseline`
...
- Evaluation 最长路径 latency：`2.324650160 s`
- DAG：6050 个节点，14000 条边
- 完整候选目录：`/Users/cookie/Documents/wiki/DAGBuilder_LLM/outputs/scoreexpert_32g_7scenes_v2_20260726_210942/s0_homogeneous/evaluations/eval_pp16_mbn64_tp2_dp1`
- 受慢卡影响的 TP group：0 个
...
|---:|---:|---:|---:|---:|---:|---|---|
| 1 | 16 | 2 | 1 | 64 | 2.324650160 | `pass` | `pass` |
| 2 | 8 | 4 | 1 | 64 | 2.456811712 | `pass` | `pass` |
| 3 | 8 | 4 | 1 | 32 | 2.475642112 | `pass` | `pass` |
| 4 | 1 | 8 | 4 | 4 | 2.476682234 | `pass` | `pass` |
| 5 | 32 | 1 | 1 | 64 | 2.635385161 | `pass` | `pass` |
| 6 | 8 | 2 | 2 | 64 | 2.657458262 | `pass` | `pass` |
| 7 | 2 | 4 | 4 | 8 | 2.660244418 | `pass` | `pass` |
| 8 | 4 | 4 | 2 | 16 | 2.661602756 | `pass` | `pass` |
| 9 | 4 | 4 | 2 | 32 | 2.672741154 | `pass` | `pass` |
| 10 | 2 | 8 | 2 | 8 | 2.699928037 | `pass` | `pass` |
...
|---|---|---:|---|
| `PP=1, TP=8, DP=4, MBN=1` | `pass` | 2.154122234 | `memory_hard_overflow` |
