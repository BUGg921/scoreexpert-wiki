...
- Status: `pass`
- Run root: `outputs/scoreexpert_db_search_20260615_084518`
...
- Latency chart: `outputs/scoreexpert_db_search_20260615_084518/latency_trend.png`
- Score chart: `outputs/scoreexpert_db_search_20260615_084518/score_trend.png`
- Replacement chart: `outputs/scoreexpert_db_search_20260615_084518/island_replacement_events.png`
- LLM usage CSV: `outputs/scoreexpert_db_search_20260615_084518/llm_usage_by_round.csv`
...
Experience events:
- `add` `global_experience`: global_experience: PP=2, TP=16, DP=1, MB=64, pp_strategy=1f1b, dp_strategy=reduce_scatter_allgather_after_backward
- `add` `global_experience`: global_experience: PP=1, TP=16, DP=2, MB=64, pp_strategy=1f1b, dp_strategy=reduce_scatter_allgather_after_backward
- `add` `island_interpretation`: island_interpretation: PP=8, TP=2, DP=2, MB=64, pp_strategy=1f1b, dp_strategy=reduce_scatter_allgather_after_backward
- `add` `island_interpretation`: island_interpretation: PP=4, TP=2, DP=4, MB=32, pp_strategy=1f1b, dp_strategy=reduce_scatter_allgather_after_backward
- `add` `global_experience`: global_experience: PP=1, TP=1, DP=32, MB=1, pp_strategy=1f1b, dp_strategy=reduce_scatter_allgather_after_backward
- `add` `global_experience`: global_experience: PP=1, TP=1, DP=32, MB=2, pp_strategy=1f1b, dp_strategy=reduce_scatter_allgather_after_backward
