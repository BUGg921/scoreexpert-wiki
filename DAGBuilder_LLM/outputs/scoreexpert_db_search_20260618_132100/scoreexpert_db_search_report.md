...
- Status: `pass`
- Run root: `outputs/scoreexpert_db_search_20260618_132100`
...
- Latency chart: `outputs/scoreexpert_db_search_20260618_132100/latency_trend.png`
- Score chart: `outputs/scoreexpert_db_search_20260618_132100/score_trend.png`
- Replacement chart: `outputs/scoreexpert_db_search_20260618_132100/island_replacement_events.png`
- LLM usage CSV: `outputs/scoreexpert_db_search_20260618_132100/llm_usage_by_round.csv`
...
- `memory_safe`: `fail`, program=``, reason=`<urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1028)>`
- `topology_affinity`: `fail`, program=``, reason=`<urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1028)>`
- `pipeline_efficiency`: `fail`, program=``, reason=`<urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1028)>`
- `balanced_generalist`: `fail`, program=``, reason=`<urlopen error [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1028)>`
